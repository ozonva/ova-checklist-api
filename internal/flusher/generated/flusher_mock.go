...
func (m *MockFlusher) Flush(ctx context.Context, checklists []types.Checklist) []types.Checklist {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Flush", ctx, checklists)
	ret0, _ := ret[0].([]types.Checklist)
	return ret0
}

// Flush indicates an expected call of Flush.
func (mr *MockFlusherMockRecorder) Flush(ctx, checklists interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flush", reflect.TypeOf((*MockFlusher)(nil).Flush), ctx, checklists)
}
