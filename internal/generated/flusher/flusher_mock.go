...
func (m *MockFlusher) Flush(checklists []types.Checklist) []types.Checklist {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Flush", checklists)
	ret0, _ := ret[0].([]types.Checklist)
	return ret0
}

// Flush indicates an expected call of Flush.
func (mr *MockFlusherMockRecorder) Flush(checklists interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flush", reflect.TypeOf((*MockFlusher)(nil).Flush), checklists)
}
